use klein::{ideal_line, line, plane, point, Dual, Line, Point};
...
fn plane_line() {
    ...
    let l1 = line(0.0, 0.0, 1.0, 4.0, 1.0, -2.0);
...
fn line_ideal_line() {
    // a*e01 + b*e01 + c*e02 + d*e23 + e*e31 + f*e12
    let l1 = line(0.0, 0.0, 1.0, 3.0, 2.0, 1.0);
    // a*e01 + b*e02 + c*e03
    let l2 = ideal_line(-2.0, 1.0, 4.0);
