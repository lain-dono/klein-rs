...
use klein::{rotor, translator, Branch, Line, Motor, Rotor};
...
#[test]
fn motor_blend() {
    let r1 = rotor(PI * 0.5, 0.0, 0.0, 1.0);
    let t1 = translator(1.0, 0.0, 0.0, 1.0);
    let m1: Motor = r1 * t1;

    let r2 = rotor(PI * 0.5, 0.3, -3.0, 1.0);
